<template>
  <input :id="id" v-model="data" :class="[errorClasses, {'w-full': $attrs.type !== 'checkbox'}]" :placeholder="placeholder" class="shadow-sm block sm:text-sm border rounded-md" type="text">
</template>
